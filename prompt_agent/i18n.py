...
_PROFILE_TRANSLATIONS = {
    "zh-CN": {
        ...
        "profiles.model_path": "GGUF 路径", "profiles.mmproj_path": "mmproj 路径", "profiles.draft_model_path": "MTP 草稿 GGUF 路径", "profiles.llama_server_path": "llama-server 路径", "profiles.n_ctx": "上下文长度", "profiles.n_gpu_layers": "GPU Layers", "profiles.thinking": "Thinking", "profiles.unload_after_turn": "每次完整回复后卸载本地模型",
